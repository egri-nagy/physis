 ...
 * License: GNU GPL
 *
 * $Id: ColorRange.java,v 1.9 2001/04/18 06:35:11 sirna Exp $
 * $Revision: 1.9 $
 * $Date: 2001/04/18 06:35:11 $
 */
...
public class ColorRange{
	...
	}catch(Exception e){e.printStackTrace();System.out.println(e.getMessage() + j); }
    }
    ...
    public Color getColor(int n) {return colors[n]; }
    public Color getDeadColor() { return Color.black; }
    public Color getNewBornColor() { return Color.darkGray; }
